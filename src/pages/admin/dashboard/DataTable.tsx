                    ...
                    <thead>
                        <tr className="border-b border-light-stroke ">
                            {columns.map((column: any, idx: number) => (
                                <th key={idx} className="text-left p-4 font-normal text-xs sm:text-sm lg:text-base text-tertiary-black font-secondary">
                                    {column.header}
                                </th>
                            ))}
                        </tr>
                        ...
                        {data.map((row, rowIdx) => (
                            <tr key={rowIdx} className="border-b border-light-stroke">
                                {columns.map((column: { header: string; key: string }, colIdx: number) => (
                                    <td key={colIdx} className="p-4 text-xs sm:text-sm lg:text-base text-secondary-black font-secondary">
