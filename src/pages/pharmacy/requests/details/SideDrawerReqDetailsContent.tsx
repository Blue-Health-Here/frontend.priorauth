...
import { FiDownload, FiEye, FiFileText, FiRotateCcw } from "react-icons/fi";
...
const RequestDetailsContent: React.FC<any> = ({ comments, setComments }) => {
    ...
    const statusItems = [
        { status: 'Awaiting feedback to Hi', date: '25-02-2025', color: 'bg-blue-500' },
        { status: 'Approved With Progress Notes', date: '25-02-2025', color: 'bg-green-500' },
        { status: 'Awaiting MD\'s Signature on Fax Form', date: '25-02-2025', color: 'bg-yellow-500' },
    ...
    return (
        <div className="flex flex-col h-full p-4 overflow-y-auto">
            ...
            <ThemeButtonTabs 
                ...
                activeTab={activeTab} setActiveTab={setActiveTab} className="w-full !h-12" />
            ...
            <div className="flex-1">
                {activeTab === 'Status & Notes' && (
                    <div className="p-4 space-y-4">
                        ...
                        <div className="border-t pt-4">
                            <h3 className="font-medium text-gray-800 mb-2">Insurance Information</h3>
                            <div className="space-y-1 text-sm text-gray-600">
