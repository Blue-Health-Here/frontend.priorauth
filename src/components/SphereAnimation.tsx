...
export default function SphereAnimation() {
    ...
    return (
        <div className="relative flex items-center justify-center transition-colors duration-300 w-full">
                        ...
                        <div className="ai-card-box z-10">
                            <div className="ai-loader-box">
                                <div className="animation-word-box">
                                    <span className="ai-word-text font-secondary">Checking medication name</span>
                                    <span className="ai-word-text font-secondary">Matching insurance plan</span>
                                    <span className="ai-word-text font-secondary">Fetching PA criteria</span>
                                    <span className="ai-word-text font-secondary">Reviewing formulary data</span>
                                    <span className="ai-word-text font-secondary">Analyzing step therapy</span>
                                    <span className="ai-word-text font-secondary">Searching insurance portals</span>
                                    <span className="ai-word-text font-secondary">Parsing policy guidelines</span>
                                    <span className="ai-word-text font-secondary">Running AI analysis</span>
                                    <span className="ai-word-text font-secondary">Verifying diagnosis rules</span>
                                    <span className="ai-word-text font-secondary">Preparing final summary</span>
                                </div>
                            </div>
                        </div>
                    </div>
