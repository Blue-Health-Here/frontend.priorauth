...
const ApprovalDenialCards = () => {
    ...
    return (
        <div className="bg-white p-6 rounded-2xl theme-shadow w-full mx-auto">
            <h2 className="text-xl font-semibold text-gray-800 mb-6">Approved vs Denied</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-800 mb-3">Approved Cases</h3>
                ...
                <div className="text-center">
                    ...
                    <h3 className="text-lg font-medium text-gray-800 mb-3">Denied Cases</h3>
