...
const RequestTableHeader = () => {
    return (
        <>
            <div className="flex flex-col sm:flex-row justify-between gap-5 pb-6">
                <Formik
                    initialValues={{ category: "", search: "" }}
                    onSubmit={() => { }}
                >
                    {() => (
                        <Form className="flex flex-col sm:flex-row md:min-w-64 flex-wrap text-grey gap-5 [&>input]:mb-3 [&>input]:placeholder:text-themeLight [&>input]:placeholder:text-[12px] w-full sm:w-auto">
                            <SelectField
