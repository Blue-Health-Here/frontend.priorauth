        ...
        <div className="flex justify-end items-center gap-3.5 flex-1">
          <div className="relative h-full" ref={notifDropdownRef}>
            <button
              ...
              className="flex items-center justify-between cursor-pointer notification-btn bg-input-bg h-full rounded-lg border relative border-input-stroke items-center p-2 w-10 py-1 px-2 sm:p-2.5"
            >
              {/* <img
          ...
          <button
            type="button"
            onClick={toggleTheme}
            className="hidden lg:flex items-center justify-center cursor-pointer h-full rounded-lg bg-input-bg border border-input-stroke p-2 w-10 py-1 px-2 sm:p-2.5"
          >
