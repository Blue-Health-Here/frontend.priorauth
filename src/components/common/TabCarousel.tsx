    ...
    return (
        <div className="relative flex items-center w-full pb-2">
            ...
            {showLeftArrow && (
                <button
                    onClick={() => scroll("left")}
                    className="absolute left-0 z-10 bg-white border border-light-stroke shadow h-max w-8 flex items-center justify-center p-2 rounded-lg cursor-pointer text-center"
                >
            ...
            {showRightArrow && (
                <button
                    ...
                    className="absolute right-0 z-10 bg-white border border-light-stroke shadow h-max w-8 flex items-center justify-center p-2 rounded-lg cursor-pointer text-center"
                >
