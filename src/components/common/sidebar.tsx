...
const Sidebar: React.FC = () => {
  ...
  const asideClass = isSidebarOpen
    ? 'max-w-[250px] min-w-[250px] xl:min-w-[260px]  xl:max-w-[260px] block bg-primary-white shadow-lg rounded-2xl text-secondary-black shadow-lg pt-8 pb-8 pl-4 pr-4 fixed z-[99]'
    : 'max-w-[250px] min-w-[250px] xl:min-w-[260px] xl:max-w-[260px] hidden lg:block bg-primary-white shadow-lg rounded-2xl text-secondary-black shadow-lg pt-8 pb-8 pl-4 pr-4 fixed z-[99]';
