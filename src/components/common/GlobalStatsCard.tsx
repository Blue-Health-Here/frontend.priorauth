...
const GlobalStatsCard: React.FC<any> = ({
  ...
  return (
    <div
      className="rounded-2xl p-5 theme-shadow bg-primary-white transition-colors min-h-full w-full flex flex-col justify-between border"
      style={{
    ...
    >
      ...
      <div className="flex items-start flex-wrap justify-between mb-2">
        ...
        <div>
          ...
          {/* Removed mb-1 */}
          <p className="text-sm text-tertiary-black mt-1">{description}</p>{" "}
          {/* Added mt-1 */}
        </div>
        <div
      ...
      <div className="flex items-center flex-wrap justify-between mt-10 px-4">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="text-center">
              {currentData.stats.map((stat: any, index: number) => {
                const previousTotal = currentData.stats
                  .slice(0, index)
                  .reduce((sum: any, s: any) => sum + s.value, 0);
        ...
        <div className="flex-1 md:ml-20">
          <div className="mb-4">
            <h4 className="text-sm md:text-base font-medium text-quaternary-white mb-1">
              Total Requests
            </h4>
